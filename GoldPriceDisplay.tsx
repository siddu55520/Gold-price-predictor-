...
const GoldPriceDisplay: React.FC = () => {
  ...
  const calculatePrice = (basePrice: number, weight: number, unit: 'grams' | 'tola') => {
    ...
    <div className="card animate-fade-in">
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-4">
          ...
          <select
            value={weightUnit}
            onChange={(e) => setWeightUnit(e.target.value as 'grams' | 'tola')}
